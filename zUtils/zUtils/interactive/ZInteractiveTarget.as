package zUtils.interactive
{
    ...
    public class ZInteractiveTarget extends Sprite
    {
        ...
        public function get targetMouseEvent() : MouseEvent { return _targetMouseEvent;}
        ...
        /** Интерактивность объекта */
        public function set interactive(value : Boolean) : void {setInteractive(value);}
         ...
         *
         */
        public function mouseUp():void {makeAction()}
